(function() {
     ...
     */
    angular
        .module('viettut', ['hc.marked', 'hljs', 'angular-markdown-editor', 'ngTagsInput', 'ngSanitize', 'ngFileUpload',
            'ladda', 'ngAnimate', 'ui.bootstrap', 'ui.codemirror', 'isteven-multi-select'])
        // .constant('config', {
        //     'API_URL' : '/api/v1/',
